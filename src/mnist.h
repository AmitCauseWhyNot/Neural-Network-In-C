...
#define TRAIN_IMAGE "data_stuff/train-images.idx3-ubyte"
#define TRAIN_LABEL "data_stuff/train-labels.idx1-ubyte"
#define TEST_IMAGE "data_stuff/t10k-images.idx3-ubyte"
#define TEST_LABEL "data_stuff/t10k-labels.idx1-ubyte"
